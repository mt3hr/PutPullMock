<template>
    <span>
        <input type="datetime-local" readonly :style="position_css" @click.stop="onclick_tag" :name="name"
...
export default class DateTimeLocalTagView extends HTMLTagViewBase {
    name: string
    value: string
    autocomplete: string
    list: string
    ...
    get tagdata_typed(): DateTimeLocalTagData { return this.tagdata as DateTimeLocalTagData }
